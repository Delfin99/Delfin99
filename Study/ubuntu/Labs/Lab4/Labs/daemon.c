...
Step 3. Call umask() to set the file mode creation mask to 0. This will allow the daemon to read and write files with the permissions / access required
...
Step 5. Close all open file descriptiors
